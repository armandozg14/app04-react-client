...
export default class AddTaco extends Component{
    ...
    catchOnload = event => console.log(event);
                ...
                <h3>Agregar taco:</h3>
                    <div className='form-group' style={{width: '50%'}}>
                        ...
                        <div>
                            ...
                            <select onLoad={this.catchOnload} onChange={this.catchSpacyness} id="option-spyciness" name="option-spyciness" style={{width: '20%'}}>
